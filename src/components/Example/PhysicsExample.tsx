...
import { OrbeElementHandle } from '../OrbeElement/OrbeElement'; // Import just the type
import { AnimationState } from '../../utils/types';
import OrbeElementPhysics from '../OrbeElement/OrbeElementPhysics';
import './Example.css';

const PhysicsExample: React.FC = () => {
